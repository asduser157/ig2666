...
def Chapterone():
    ...
    - ''')
    if dragon_attack == '2':
        typingPrint('''As everyone else runs away, you stand there, frozen with fear. The dragon sees you as an easy target. It dives towards you... and disintegrates you with its fireball breath.''')
        blink("\nGAME OVER")
