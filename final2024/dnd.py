...
GAME OVER''')
        ...
        if surprise_attack == '1':
            typingPrint('''You hold the sword with both hands. You leap up at the Master Worm's head, confident that you can clear the jump. However, the Master Worm moves it's head higher and you fall directly into it's mouth.
    GAME OVER''')
